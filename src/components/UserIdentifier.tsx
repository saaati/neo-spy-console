    ...
    <Card className="cyber-border bg-card/30 backdrop-blur-sm">
      <CardHeader>
        <CardTitle className="text-primary font-mono flex items-center space-x-2">
          ...
          <span>IDENTIFICAÇÃO DE USUÁRIOS</span>
        </CardTitle>
      </CardHeader>
      <CardContent>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-mono text-primary font-semibold">{user.name}</h3>
              ...
              <div className="mt-2 pt-2 border-t border-primary/20">
                <p className="text-xs text-muted-foreground">
                  Última atividade: <span className="text-primary">{user.lastSeen}</span>
                </p>
              </div>
            </div>
          ))}
        ...
        <div className="mt-4 p-3 bg-primary/5 rounded-lg border border-primary/20">
          <p className="text-xs text-muted-foreground font-mono">
            <span className="text-primary">INFO:</span> Todos os dados exibidos pertencem ao usuário selecionado. 
            Clique em um usuário para filtrar as informações nos painéis.
          </p>
        </div>
      </CardContent>
    </Card>
